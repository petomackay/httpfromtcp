...
func TestRequestLineParser(t *testing.T) {
	...
	//Test: Invalid method order request line
	_, err = RequestFromReader(strings.NewReader("/coffee POST HTTP/1.1.\r\nHost: localhsot:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)

	// Test: Invalid version in request line
	_, err = RequestFromReader(strings.NewReader("GET /coffee HTTP/8.1.\r\nHost: localhsot:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)

	// Test: Invalid method name in request line
	_, err = RequestFromReader(strings.NewReader("SEND /coffee HTTP/1.1.\r\nHost: localhsot:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)
